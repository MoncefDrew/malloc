...
# 5 "alloc.h" 2
# 1 "/usr/lib/gcc/x86_64-redhat-linux/15/include/stdbool.h" 1 3 4
# 6 "alloc.h" 2
...
typedef struct __attribute__((__packed__)) s_header header;
# 49 "alloc.h"
void show_(header*);
...
header *findblock_(header* hdr, word allocation ,word n){
    ...
    if((n+allocation) > ((1024*1024*1024/4)-1 - 2)){
        do { 
# 12 "alloc.c" 3 4
       (*__errno_location ()) 
# 12 "alloc.c"
       = (1) ; return (void *) 0; }while(false);
    }
...
void *mkalloc(word words, header *hdr){
    ...
    if(words > ((1024*1024*1024/4)-1 -wordsin)){
        do { 
# 38 "alloc.c" 3 4
       (*__errno_location ()) 
# 38 "alloc.c"
...
void *alloc(int32 bytes){
    ...
    hdr = findblock_((header *) memspace, (words),0 );
    if (!hdr) {
        return (void *) 0;
    }

    if (words > (1024*1024*1024/4)-1){
        do { 
# 60 "alloc.c" 3 4
       (*__errno_location ()) 
# 60 "alloc.c"
